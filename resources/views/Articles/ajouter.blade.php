...
<html lang="en">
  ...
  <body>
    <h1 class="text-center mt-4">Ajouter un bien immobilier</h1>
    <div class="container">
    ...
    <form method="POST" action="sauvegarder_article">
        ...
        <div class="mb-3">
            ...
            <input type="url" class="form-control" id="url_img" name="url_img" >
            @error('url_img')
            <div class="alert alert-danger">{{ $message }}</div>   
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <select id="cathegorie" name="cathegorie" class="form-select" >
        ...
        <a href="afficher_article" class="btn btn-danger">Annuler</a>
