...
<html lang="en">
  ...
  <body>
    ...
    <form method="POST" action="{{ url('modifier/'.$article->id) }}" >
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="url" class="form-control" id="url_img" name="url_img"  value="{{ $article->url_img }}">
        </div>
        <div class="mb-3">
            <label for="desc" class="form-label">Description *</label>
            <textarea class="form-control" id="desc" name="desc" required>{{ $article->desc}} </textarea>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="localisation" name="localisation" value="{{ $article->localisation }}" required>
        </div>
        <div class="mb-3">
